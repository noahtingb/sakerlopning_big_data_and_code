...
def createparams(data,time=[2025,4,2,0],cords=[57,12]):
    ...
    if timestr in data["hourly"]["time"]:
        ...
        params={"year":time[0],"month":time[1],"day":time[2],"hour":time[3],"Ta":data["hourly"]["temperature_2m"][indexforsearch],"SwR":data["hourly"]["shortwave_radiation"][indexforsearch],"RH":data["hourly"]["relative_humidity_2m"][indexforsearch],"Ws":data["hourly"]["wind_speed_10m"][indexforsearch],"sky":"Clear (100%)","c1":data["hourly"]["cloud_cover_low"][indexforsearch],"c2":data["hourly"]["cloud_cover_mid"][indexforsearch],"c3":data["hourly"]["cloud_cover_high"][indexforsearch],"radI":data["hourly"]["direct_radiation"][indexforsearch], "radD":data["hourly"]["diffuse_radiation"][indexforsearch], "loc":{'latitude': cords[0],'longitude': cords[1], 'altitude': data["elevation"]},"UTC":0}
        return params
    return None
